...
\end{align}
where $r$ is defined in \eqref{eigr}, and $\{ \mu_1, \dots, \mu_{m-1} \}$ are the distinct, real, nonzero eigenvalues of the symmetric, tridiagonal matrix
